...
const accordinationitem = [
  {
    question: "jobyab چیست؟",
    answer:
      "jobyab یک اپلیکیشن پورتال شغلی است که به شرکت‌ها اجازه می‌دهد آگهی‌های شغلی را منتشر کنند و کاربران می‌توانند به جستجو و درخواست شغل بپردازند. این اپلیکیشن امکاناتی برای جویندگان کار و کارفرمایان فراهم می‌کند و دارای رابط کاربری کاربرپسند و احراز هویت امن است.",
  },
  {
